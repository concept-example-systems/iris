...
\begin{table}[htbp]
    \centering\begin{tabular}{l r r r}
        \hline
        \textbf{Model} & \textbf{Accuracy} & \textbf{F1-score} & \textbf{Steps} \\
        \hline
        \texttt{bert-large} & 95.77 & 78.15 & 50 000 \\
        \hline
        \texttt{albert-xxl} & \textbf{97.05} & \textbf{84.14} & 5 000\\
        \hline
    \end{tabular}
...
(in terms of the number of steps, not the wall clock time). As a result we have decided to use the fine-tuned \texttt{albert-xxl} 
